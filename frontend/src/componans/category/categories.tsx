    ...
    return (
        <div className='backdark'>
            <div className='container'>
                <div className='catalog-categories2'>
                    <div className="catalog-slider2">
                            <ul className="catalog-list2">
                                <li className="catalog-item2">
                                    <a href="#" className="catalog-link2">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="left-icon2">
                                        ...
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="right-icon2">
                            ...
                            <li className="categories-item">
                                <ul className="product-list">
                                    <li className="product-item">
                                        <a href="#" className="product-link">Galaxy S23 | S23+ | S23 Ultra</a>
                                    </li>
                                    <li className="product-item">
                                        <a href="#" className="product-link">Galaxy A54</a>
                                    </li>
                                </ul>
                            </li>
                            <li className="categories-item">
                                <ul className="product-list">
                                    <li className="product-item">
                                        <a href="#" className="product-link">Redmi Note 12 | 12 Pro</a>
                                    </li>
                                    <li className="product-item">
                                        <a href="#" className="product-link">Redmi 10 2022</a>
                                    </li>
                                    <li className="product-item">
                                        <a href="#" className="product-link">Redmi 9A | 9C | 12C</a>
                                    </li>
                                </ul>
                            </li>
                            <li className="categories-item">
                                <ul className="product-list">
                                    <li className="product-item">
                                        <a href="#" className="product-link">iPhone 14 Pro | 14 Pro Max</a>
                                    </li>
                                    <li className="product-item">
                                        <a href="#" className="product-link">iPhone 13 | 13 mini</a>
                                    </li>
                                    <li className="product-item">
                                        <a href="#" className="product-link">iPhone 14 | 14 Plus</a>
                                    </li>
                                    <li className="product-item">
                                        <a href="#" className="product-link">iPhone 11</a>
                                    </li>
                                </ul>
                            </li>
                            <li className="categories-item">
                                <ul className="product-list">
                                    <li className="product-item">
                                        <a href="#" className="product-link">Camon 19 | Camon 19 Neo</a>
                                    </li>
                                </ul>
                            </li>
                            <li className="categories-item">
